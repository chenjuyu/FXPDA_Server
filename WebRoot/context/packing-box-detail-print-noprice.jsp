...
<%
	...
	if(null == map){
		request.getRequestDispatcher("/common.do?packingBoxDetailPrintNoPrice").forward(request, response);
		return;
	}
...
<%-- 						<td class="right"><fmt:formatNumber type="number" value="${d.retailSales}" pattern="0.00" maxFractionDigits="2"/></td> --%>
					</tr>
				</c:forEach>
					<tr>
