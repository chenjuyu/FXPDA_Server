...
<%
	...
	if(null == map){
		request.getRequestDispatcher("/common.do?packingBoxDetailPrintVip").forward(request, response);
		return;
	}
		...
		<div class="detail">
			<table class="t_d" border="1" cellspacing="0" cellpadding="0">
				...
				<c:forEach begin="0" end="${fn:length(datas.dataList)}" items="${datas.dataList}" var="d" varStatus="status">
					...
					<tr>
						<td colspan="5" class="center">汇总/${fn:length(datas.dataList)}</td>
