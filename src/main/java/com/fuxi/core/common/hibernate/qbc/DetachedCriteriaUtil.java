...
import com.fuxi.system.util.ContextHolderUtils;
...
public class DetachedCriteriaUtil {
     ...
     * user.organization.parentOrganization.parentOrganization.orgName 但请注意1点 ,连接采用内联，级联越多，结果集可能就越少；
     * 
     * @author
     * @param columnNames 字符串数组，以数据的形式接收要查询的字段属性，如String[] column={"属性1","属性2","属性3"};
