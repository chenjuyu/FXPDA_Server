...
public abstract class GenericBaseCommonDao<T, PK extends Serializable> implements IGenericBaseCommonDao {
    ...
    // @Autowired
    // @Qualifier("systemSessionFactory")
    // private SessionFactory systemSessionFactory;
    ...
    // // 事务必须是开启的(Required)，否则获取不到
    // return systemSessionFactory.getCurrentSession();
    // }
     ...
     * 调用存储过程
     */
    public Map callableStatementByName(Procedure procedure) {
    ...
    public List<Map<String, Object>> findForJdbcSystem(String sql, Object... objs) {
        // DataSourceContextHolder.setDataSourceType(DataSourceConst.System);
        return this.systemJdbcTemplate.queryForList(sql, objs);
    }

    public int getDataToSystem(String sql, Object... param) {
        // DataSourceContextHolder.setDataSourceType(DataSourceConst.System);
        return systemJdbcTemplate.queryForInt(sql, param);
    }

    public int getDataToInt(String sql, Object... param) {
        return jdbcTemplate.queryForInt(sql, param);
    }

    public Object getDataToSystemForObj(String sql, Object... param) {
        // DataSourceContextHolder.setDataSourceType(DataSourceConst.System);
        return systemJdbcTemplate.queryForObject(sql, Object.class, param);
    }

    public Boolean getDataForBoolean(String sql, Object... param) {
        // DataSourceContextHolder.setDataSourceType(DataSourceConst.System);
        return jdbcTemplate.queryForObject(sql, Boolean.class, param);
    }

    public String getDataForString(String sql, Object... param) {
        // DataSourceContextHolder.setDataSourceType(DataSourceConst.System);
        return jdbcTemplate.queryForObject(sql, String.class, param);
    }

    public Integer executeDataToSystem(String sql, Object... param) {
        // DataSourceContextHolder.setDataSourceType(DataSourceConst.System);
        return this.systemJdbcTemplate.update(sql, param);
    }

    public Integer getOneData(String sql, Object... param) {
        // DataSourceContextHolder.setDataSourceType(DataSourceConst.System);
        return this.jdbcTemplate.queryForInt(sql, param);
    }

    public Object getObjectData(String sql, Object... param) {
        // DataSourceContextHolder.setDataSourceType(DataSourceConst.System);
        return this.jdbcTemplate.queryForObject(sql, Object.class, param);
    }
    ...
    public PageList getPageList(final CriteriaQuery cq, final boolean isOffset) {
        ...
        int maxPage = (int) Math.ceil((double) allCounts / pageSize);// 最大页数
        ...
        return new PageList(criteria.list(), toolBar, offset, curPageNO, allCounts, maxPage);
    }
    ...
    public PageList getPageList(final HqlQuery hqlQuery, final boolean needParameter) {
        ...
        int allCounts = query.list().size();
        int curPageNO = hqlQuery.getCurPage();
        int maxPage = (int) Math.ceil((double) allCounts / hqlQuery.getPageSize());// 最大页数
        int offset = PagerUtil.getOffset(allCounts, curPageNO, hqlQuery.getPageSize());
        String toolBar = PagerUtil.getBar(hqlQuery.getMyaction(), allCounts, curPageNO, hqlQuery.getPageSize(), hqlQuery.getMap());
        query.setFirstResult(offset);
        query.setMaxResults(hqlQuery.getPageSize());
        return new PageList(query.list(), toolBar, offset, curPageNO, allCounts, maxPage);
    }
    ...
    public Object getData(String sql, Object param) {
        return getSession().createSQLQuery(sql).setParameter(0, param).uniqueResult();
    }
    ...
    public Object get(String hql) {
        Object o = null;
        List<Object> list = (List<Object>) findByQueryString(hql);
        if (list.size() > 0) {
            o = list.get(0);
        }
        return o;
