...
public class FormValidationTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            if (action != null) {
                ...
                if (index != -1) {
                    String actionurl = action.substring(0, index);
    ...
    public int doEndTag() throws JspException {
        try {
             ...
             * sb.append("tiptype:"+this.getTiptype()+","); }else{ sb.append("tiptype:1,"); }
             */
            // blur不提示，我也不知道行不行
            sb.append("tipSweep:true,");
            // 我要更改提示方式了

            sb.append("tiptype:function(msg,o,cssctl){ ");
            sb.append("     if(!o.obj.is(\"form\")){  ");
            sb.append(" if(o.type==3)alert(msg); }else{ ");
